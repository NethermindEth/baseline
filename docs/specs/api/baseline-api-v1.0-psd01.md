...
| :--- | :--- |
| BRPC1|# track<br>Description:  Initializes a merkle tree database for the given Shield contract address and starts tracking new tree events. <br>interface: api.IBaselineRPC. <br>jsonrpc: baseline_track <br>caveats: <br>Parameters: <br> - DATA - address of the Shield contract<br>Returns: -<br>Example:|
| BRPC2|# getTracked<br>description:  Retrieves a list of the shield contract addresses being tracked and persisted. <br>interface: api.IBaselineRPC. <br>jsonrpc: baseline_getTracked <br>caveats: <br>Parameters: -<br>Returns: <br> - Array&lt;DATA&gt; - list of all tracked Shield contracts<br>Example:|
| BRPC3| # getLeaf <br>description:  Retrieves a single leaf from a tree at the given shield contract address. <br>interface: api.IBaselineRPC <br>jsonrpc: baseline_getLeaf <br>caveats: <br>Parameters: <br> - DATA - Shield contract address<br> - QUANTITY - leaf index<br>Returns:<br> - MERKLE_TRIE_NODE<br>Example:|
| BRPC4| # getLeaves <br>description:  Retrieves multiple leaves from a tree at the given shield contract address. <br>interface: api.IBaselineRPC. <br>jsonrpc: baseline_getLeaves <br>caveats: <br>Parameters:<br> - DATA - Shield contract address<br> - Array&lt;QUANTITY&gt; - leaf indexes<br>Returns:<br> - Array&lt;MERKLE_TRIE_NODE&gt;<br>Example:|
| BRPC5| # getRoot <br>description:  Retrieves the root of a tree at the given shield contract address <br>interface: api.IBaselineRPC.<br>jsonrpc: baseline_getRoot <br>caveats: <br>Parameters:<br> - DATA - Shield contract address<br>Returns:<br> - MERKLE_TRIE_NODE<br>Example:|
| BRPC6|# getSiblings <br>description:  Retrieves siblings path/proof of the given leaf index. <br>interface: api.IBaselineRPC. <br>jsonrpc: baseline_getSiblings <br>caveats: <br>Parameters:<br> - DATA - address of the Shield contract<br> - QUANTITY - leaf index to prove<br>Returns:<br> - Array&lt;MERKLE_TRIE_NODE&gt; - siblings path<br>Example:|
| BRPC7|# verify <br>description:  Verifies a sibling path for a given root and leaf at the given shield contract address. <br>interface: api.IBaselineRPC.<br>jsonrpc: baseline_verify <br>caveats: <br>Parameters:<br> - DATA - address of the Shield contract<br> - DATA - root node hash<br> - DATA - hash of the leaf node to be verified<br> - Array&lt;DATA&gt; - siblings path/proof<br>Returns:<br> - bool - verification result<br>Example:| 
| BRPC8|# verifyAndPush<br>description: <br>interface: api.IBaselineRPC.<br>jsonrpc: baseline_verify <br>caveats: <br>Parameters:<br>- DATA - address of the transaction sender<br>- DATA - address of the Shield contract<br>- Array&lt;DATA&gt; - proof data<br>Array&lt;DATA&gt; - public inputs<br> - DATA - commitment<br>Returns:<br>Example:| 
| BRPC9 | # deploy <br>description:  Deploys a shield contract given the compiled artifact bytecode and ABI.<br>interface: api.IBaselineRPC.deploy is this correct ? <br>jsonrpc: baseline_deploy <br>caveats: Optional and only used for dev/testing<br>Parameters:<br>DATA - address of the deploying transaction sender<br>string - type of the contract to be deployed<br>Returns: -<br>Example:|
-------
